...
const correctAnswers = {
    ...
    acronym: "Digital Audio Workstation",
    company: "Soundstream",
    freeResponse: "not available at the moment. Instructor will grade response later",
    fileFormat: "Audio File",
    checkQuestion: [ "Ableton Live", "FL Studio", "REAPER"],
    optionQuestion: "Pro Tools"

        // stop here - you can have more lines if your quiz has more answers
};
